...
{
    /// <summary>
    ///   StraightArrow - a wiggly robot by Erik and Calvin
    /// </summary>
    public class StraightArrow : AdvancedRobot
    {
        private List<IDoIt> TurnList = new List<IDoIt>() { new Turn { Radius = 114, Angle = 120 } 
